...
REF_MIN_SCORE = {
    ...
    'halfcheetah-random-v2' : -280.178953 ,
    'walker2d-random-v2' : 1.629008 ,
    'hopper-random-v2' : -20.272305 ,
    'ant-random-v2' : -325.6,
...
REF_MAX_SCORE = {
    ...
    'halfcheetah-random-v2' : 12135.0 ,
    'walker2d-random-v2' : 4592.3 ,
    'hopper-random-v2' : 3234.3 ,
    'ant-random-v2' : 3879.7,
...
for env in ['halfcheetah', 'hopper', 'walker2d', 'ant']:
    for dset in ['random', 'medium', 'expert', 'medium-replay', 'full-replay', 'medium-expert']:
        ...
        if dset != 'random':
            REF_MIN_SCORE[env_name] = REF_MIN_SCORE[env + '-random-v2']
            REF_MAX_SCORE[env_name] = REF_MAX_SCORE[env + '-random-v2']
